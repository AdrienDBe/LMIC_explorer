...
# === APPLY FILTERS ALWAYS (WIDGET VALUES CHANGED) ===
...
if 'Country' not in filtered_df.columns:
    ...
    with col_map1:
        ...
        # Calculate map data (filters already applied in filtered_df)
    ...
    # Calculate search results (filters already applied in filtered_df)
